(function() {
	...
	function BusinessDetailsController(
		...
		function showWordpress() {
			console.log("Business send Wordpress link: " + business.wordpress);
			var url  = business.wordpress;
			$state.go('app.wordpress-articles',{"url":url});
		}

		function showDrupal() {
			console.log("Business send Drupal link: " + business.drupal);
			var url  = business.drupal;
			$state.go('app.drupal-articles',{"url":url});
		}
