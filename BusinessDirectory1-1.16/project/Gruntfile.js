...
module.exports = function (grunt) {
			...
			development: {
				constants: {
					ENV: {
						...
						// dataProvider: 'REMOTE',
						// apiUrl: 'https://skounis.s3.amazonaws.com/mobile-apps/business-directory/',
						// dataProvider: 'LOCAL',
						// apiUrl: 'misc/',
			...
			cloud: {
				files: [{
					...
					src: [
						...
						'node_modules/backendless/dist/backendless.js'
					]
				}]
			},
			styles: {
	...
	grunt.registerTask('build', function () {
		return grunt.task.run(['init', 'ionic:cordova:build:' + this.args.join()]);
	});
